...
export type SharingOverviewQuery = { pendingShareOffers: { edges: Array<{ node: { id: string, profileId: string, householdId: string, status: ProfileShareStatus, expiresAt: string | null } }> }, profileShares: { edges: Array<{ node: { id: string, householdId: string, status: ProfileShareStatus, structural: boolean } }> } };

export type SharePreflightQueryVariables = Exact<{
  profileId: string | number;
  householdId: string | number;
}>;


export type SharePreflightQuery = { sharePreflight: { wouldLock: boolean, nameConflict: boolean } | null };
...
export type AcceptProfileShareMutation = { acceptProfileShare: { share: { id: string, status: ProfileShareStatus } | null, userErrors: Array<
      | { __typename: 'NoEligibleAdminError', message: string }
...
export type EndProfileShareMutation = { endProfileShare: { share: { id: string, status: ProfileShareStatus } | null, userErrors: Array<
      ...
      | { __typename: 'ShareNotFoundError', message: string }
      | { __typename: 'StructuralShareError', message: string }
    > } | null };
